...
<html lang="ja">
  <head>
    <meta charset="utf-8">
    <title>Application uploader</title>
  </head>
  <body>
    <div id="wrap">

      <div id="upload_holder">
        <h1>CU Application Uploader</h1>
            ...
            <form method="post" id="regist" enctype="multipart/form-data">
              <table>
                ...
                <tr>
                  <td>Category</td>
                  <td>
                    <input type="checkbox" name="categories[]" value="Game">Game
                    <input type="checkbox" name="categories[]" value="CG">CG
                    <input type="checkbox" name="categories[]" value="Geometry">Geometry
                    <input type="checkbox" name="categories[]" value="Web">Web
                    <input type="checkbox" name="categories[]" value="Jsdoit">jsdo.it
