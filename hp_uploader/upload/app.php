  ...
  function start($mysqli){
    ...
    try{
      ...
      try{
        ...
        $sql_add = "INSERT INTO app( name, link, category, reg_date) ";
        $sql_add .= "VALUES( ";
        ...
        try{
          ...
          if(is_uploaded_file($_FILES["file"]["tmp_name"])) {
            ...
            if($width >= $min_width || $height >= $min_height){
              ...
              if (!file_exists("../apps/img/thumbnail/" . $next_id . ".jpg")) {
                ImageJPEG($out, "../apps/img/thumbnail/" . $next_id . ".jpg");
              } else{
            ...
            if(mysqli_query( $mysqli, "DELETE FROM app WHERE id = '" . $next_id . "'" )){
